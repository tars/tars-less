...
module.exports = function () {
    ...
    return gulp.task('css:make-sprite', function () {
                    ...
                    spritesmith(
                        {
                            ...
                            padding: (i + 1) * 4,
                            cssTemplate: './markup/' + staticFolderName + '/less/sprite-generator-templates/less.sprite.mustache'
                        }
                    )
                )
            );
        ...
        return spriteData[0].css.pipe(gulp.dest('./markup/' + staticFolderName + '/less/sprites-less/'))
                .pipe(notifier.success('Less for sprites is ready'));
    });
};
